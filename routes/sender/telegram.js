...
info.urls = function (activity) {
    ...
    return {
        telegram_screen_url: `${config.host}${config.rootPath}/#/wall/${activity.id}/telegramScreen/${telegramScreenToken.token}`,
        telegram_webhook: `${config.host}${config.rootPath}/#/wall/${activity.id}/telegram/${telegramWebhookToken.token}`
    };
};
...
router.all(
    ...
    async function (req, res) {
        ...
        bot.setWebHook(info.urls.telegram_webhook);
        bot.on('message', msg => {
